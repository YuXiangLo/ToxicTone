...
def prepare_data(
    ...
    train_data = [(emb, label) for emb, label, id_ in zip(clean_wavlm_embeddings, clean_labels, clean_ids) if id_ in train_ids]
    test_data = [(emb, label) for emb, label, id_ in zip(clean_wavlm_embeddings, clean_labels, clean_ids) if id_ in test_ids]
